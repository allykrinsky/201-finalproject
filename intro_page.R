...
U.S. DJIA was accessed from ecoddata, and the data is updated daily from the stock market. DJIA is an index measuring the stock 
performance of 30 companies which are the most valuable companies in the U.S. and can largely influence the overall economy of the U.S.. 
...
Using these two data sets, we are going to have a better understanding of the US economy, and their interrelation. For more background
knowledge on economics to help understand our report."
...
third_tab <- paste("United States GDP Tab will provide help answer the question: Is there any correlation between geographic locations and GDP?",
                   "Our GDP analysis will provide you with a better understanding of the US economy by providing the GDP stats in individual states and region. 
                   You can choose two regions including states and larger areas, and a certain industry. Then the graph will show the U.S. GDP trend and GDP 
                   tend in these two regions from 2005 to 2018 in each quarter in the certain industry. If you choose to compare two states’ GDP change, the 
                   graph can visualize the GDP change trend in these two states and visualize the correlation between them. If you choose to compare a state
                   to a larger area, you can see if the state’s GDP influence the GDP change in that larger area. For example, you can choose Minnesota 
